...
# Creating a color for the game_mode page
game_mode_color = (107, 105, 105)
...
creative_game = pygame.Rect(140, 250, 200, 520)
survival_game = pygame.Rect(390, 250, 200, 520)
opponent_game = pygame.Rect(640, 250, 200, 520)
...
def Game_mode_menu():
    ...
    while True:
        ...
        screen.blit(game,(530,70))
         ...
         # Visuals 
        pygame.draw.rect(screen, game_mode_color, creative_game, 100, 20)
        pygame.draw.rect(screen, game_mode_color, survival_game, 100, 20)
        pygame.draw.rect(screen, game_mode_color, opponent_game, 100, 20)
